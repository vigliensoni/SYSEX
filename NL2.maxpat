...
,
		"rect" : [ 2.0, 315.0, 1406.0, 749.0 ],
		"bglocked" : 0,
		"defrect" : [ 2.0, 315.0, 1406.0, 749.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "midiin",
					"patching_rect" : [ 747.0, 513.0, 42.0, 20.0 ],
					"id" : "obj-87",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "pc Virus",
					"patching_rect" : [ 567.0, 477.0, 52.0, 20.0 ],
					"id" : "obj-83",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 571.0, 477.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r pc",
					"patching_rect" : [ 621.0, 477.0, 31.0, 20.0 ],
					"id" : "obj-84",
					"fontname" : "Arial",
					"numinlets" : 0,
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 625.0, 477.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "midiformat",
					"patching_rect" : [ 576.0, 513.0, 100.0, 20.0 ],
					"id" : "obj-85",
					"fontname" : "Arial",
					"numinlets" : 7,
					...
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"presentation_rect" : [ 580.0, 513.0, 0.0, 0.0 ],
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "midiout",
					"patching_rect" : [ 576.0, 543.0, 100.0, 20.0 ],
					"id" : "obj-86",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 11.595187,
					"numoutlets" : 0,
					"presentation_rect" : [ 580.0, 543.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "pc Virus",
					"patching_rect" : [ 432.0, 477.0, 52.0, 20.0 ],
					"id" : "obj-81",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r pc",
					"patching_rect" : [ 486.0, 477.0, 31.0, 20.0 ],
					"id" : "obj-79",
					"fontname" : "Arial",
					"numinlets" : 0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "midiformat",
					"patching_rect" : [ 441.0, 513.0, 100.0, 20.0 ],
					"id" : "obj-77",
					"fontname" : "Arial",
					"numinlets" : 7,
					"color" : [ 0.0, 0.780392, 0.070588, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "midiout",
					"patching_rect" : [ 441.0, 543.0, 100.0, 20.0 ],
					"id" : "obj-78",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 11.595187,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "66",
					"patching_rect" : [ 1224.0, 387.0, 32.5, 18.0 ],
					"id" : "obj-63",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "90",
					"patching_rect" : [ 1233.0, 414.0, 32.5, 18.0 ],
					"id" : "obj-58",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "89",
					"patching_rect" : [ 1224.0, 522.0, 32.5, 18.0 ],
					"id" : "obj-57",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "63",
					"patching_rect" : [ 1224.0, 441.0, 32.5, 18.0 ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
